...
INSERT INTO `ogloszenia` (`id_og`, `id_uz`, `id_kat`, `nazwa`, `cena`, `data_wys`, `email_wys`, `nr_tel_wys`, `opis`, `wojewodztwo`, `miasto`, `adres`,`promowane`, `aktywne`, `zdjecie`, `atrybuty`) VALUES
(1, 1, 1, 'Sprzedam opla', '500.00', '2017-11-21 19:52:15', 'janusz@wp.pl', '653434212', 'sprzedam opla nie bity nie stukany na oko rocznik 2010, mały przebieg cena do nego kontakt na priv wymienie za 2 swiezaki dla horej curki', 'mazowieckie', 'siedlce', 'sekulska 4','0' ,'1', '1-0.jpg', "['Opel', 'Insignia', 'używany', '2010', '5', '100000']"),
(2, 1, 1, 'Sprzedam opla corse b rocznik 1998', '800.00', '2017-11-29 19:02:20', 'janusz@wp.pl', '65434212', 'Sprzedam opla corse nie bity nie stukany rocznik 1998 wszystkie papiery na miejscu, cena do negocjacji, brak możliwości wymiany za świerzaki', 'mazowieckie', 'siedlce', 'sekulska 5', '1', '1', '2-0.jpg', "['Opel', 'Corsa B', 'używany', '1998', '3', '400000']"),
(3, 1, 2, 'Piękna ławeczka ogrodowa', '250.00', '2017-11-30 21:02', 'janusz@wp.pl', '654545212', 'sprzedam piękną ławeczkę ogrodową, nie klepana, mały przebieg, jedna deska nadpęknięta bo raz teściowa usiadła mimo zakazu', 'mazowieckie', 'siedlce', 'sekulska 6', '0', '1', '3-0.jpg', "['60', '200', '40']"),
(4, 2, 2, 'Stół kuchenny idealny do krojenia mięsa', '300.00', '2017-12-02 19:08:45', 'uczeń@wp.pl', '675849301', 'Sprzedam piękny stół kuchenny, lekkie ślady używania, idealny do krojenia mięs rodzaju wszelakiego', 'mazowieckie', 'siedlce', 'sienkiewicza 3', '1', '1', '4-0.jpg', "['110', '180', '140']"),
...
(8, 4, 5, 'Niewidzialna bluza niewidka', '10000.00', '2017-12-02 20:43:21', 'nieuczeń@wp.pl', '793046271', 'Sprzedam niewidzialną bluzę niewidkę, nie widać jej, ale to dlatego, że jest niewidzialna, no scam legit 100%', 'mazowieckie', 'siedlce', 'sienkiewicza 4', '1', '1', '8-0.jpg', "['dowolny', 'magiczna bawełna']"),
