...
INSERT INTO `uzytkownicy` (`id_uz`, `imie`, `nazwisko`, `adres`, `nr_tel`, `haslo`, `login`, `email`, `funkcja`, `miasto`, `wojewodztwo`, `data_rej`, `o_sobie`, `aktywny`) VALUES
(1, 'Janusz', 'Tracz', 'Letnia 20/1', '632543675', '$2y$11$ZsLom.N5w.dW.XzjkqaHPurgwe9xdOS.npZ5IXxE8mBsUB4Z7VJie', 'janusz', 'janusz@wp.pl', 'user', 'Lublin', 'woj. lubelskie', '0000-00-00 00:00:00', 'Jestem *byznesmenem* i szefem prosperującej firmy zajmującej się głównie handlem passatami.', '1'),
(2, 'user', 'user', 'uszwica1', '333333', '$2y$11$5Dyl3FGRQ4BBGPdfBZ2eD.D5Q.SAi4/ryYql6arEJVNF/Af7jb0YO', 'uzytkownik1', 'jajusz@jajusz.pl', 'user', 'uszwice', 'woj. śląskie', '2017-11-26 16:29:25', 'Jestem zwyczajnym przykładowym użytkownikiem tego serwisu, autor nie miał pomysłu na szczegółowe dane użytkowników.', '1'),
(3, 'Sergiusz', 'Surow', 'Jesienna 21/2', '77668855', '$2y$11$hL.X2FQqUuqYbLZ6tbGaf.UQSsSTPiSPgzjqGBUJUdy84OSEPtdYW', 'uczen', 'uczen@janusz.pl', 'user', 'Lodowice', 'woj. pomorskie', '2017-11-29 17:28:12', 'Jestem rosyjskim imigrantem, który przyjechał do polski w poszukiwaniu pierogów.', '1'),
(4, 'Administrator', 'Serwisu', 'Jeja.pl', '99880077', '$2y$11$IKgxrfQcz7OYgvvHjSRVzOsNXHKQ/tkBBwPYLLMAkWJSU6lZnZHtq', 'admin', 'admin@gmail.com', 'admin', 'Internet', 'Region', '2017-11-29 17:30:12', 'Jestem przykładowym administratorem serwisu, ale nie wiadomo nawet, czy będę pełnił tutaj jakąś funkcję z powodu braku czasu na dodanie panelu administratora.', '1'),
(5, 'Tajny', 'Tajniak', 'Tajne', 'Tajny', '$2y$11$6FKUMzEdof4ZTJ4cDK8lsuvGZlU8In9B9DUsCBMyaTQMcvGctZgaK', 'tajny', 'tajny@email.com', 'admin', 'Tajne', 'Region', '2017-11-29 17:31:13', 'Nikt nie musi tego wiedzieć.', '1');
...
(12, 1, 9, "Zabawka dla dziecka, pluszowy lis pirat", "19.87", "2017-12-03 11:58:34", "2018-01-03 11:58:34", "moeuczeń@wp.pl", "583750476", "Sprzedam zabawkę dla dziecka, jest to pluszowy lis pirat, stan idealny - był to nietrafiony prezent, ciotka pomyślała, że dawanie pluszaka 14-letniemu Brajankowi to dobry pomysł", "mazowieckie", "siedlce", "słowackiego 5", "0", "12-0.jpg", '["plusz"]'),
(13, 1, 1, "Sprzedam opla corse b rocznik 1998 (zarchiwizowany przykład)", "800.00", "2017-11-29 19:02:20", "2017-10-29 19:02:20", "janusz@wp.pl", "65434212", "Sprzedam opla corse nie bity nie stukany rocznik 1998 wszystkie papiery na miejscu, cena do negocjacji, brak możliwości wymiany za świerzaki", "mazowieckie", "siedlce", "sekulska 5", "1", "2-0.jpg", '["Opel", "Corsa B", "używany", "1998", "3", "400000"]'),
(14, 1, 1, "Sprzedam opla corse b rocznik 1998 (zarchiwizowany przykład 2)", "800.00", "2017-11-29 19:02:20", "2017-10-29 19:02:20", "janusz@wp.pl", "65434212", "Sprzedam opla corse nie bity nie stukany rocznik 1998 wszystkie papiery na miejscu, cena do negocjacji, brak możliwości wymiany za świerzaki", "mazowieckie", "siedlce", "sekulska 5", "1", "2-0.jpg", '["Opel", "Corsa B", "używany", "1998", "3", "400000"]');
